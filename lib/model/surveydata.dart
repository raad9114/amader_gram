...
List<Surveydata> surveydataFromJson(String str) => List<Surveydata>.from(json.decode(str).map((x) => Surveydata.fromJson(x)));

String surveydataToJson(List<Surveydata> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
