import 'dart:convert';
import 'package:amader_gram_main/screen/follow_up_assesment.dart';
...
class Get_All_Data extends StatefulWidget {
  ...
  @override
  State<Get_All_Data> createState() => _Get_All_DataState();
}

class _Get_All_DataState extends State<Get_All_Data> {
  String searchid = " ";
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (_, index) => Column(
                              ...
                              children: [
                                ...
                                ]else if(widget.role == 'MA' && index+1 == snapshot.data!.length && !snapshot.hasError)...[
                                  Center(
                                    child: RaisedButton(
                                      onPressed: () async {
                                        print(index);
