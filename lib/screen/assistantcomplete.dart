...
class assistantcompleted extends StatefulWidget {
  ...
  @override
  State<assistantcompleted> createState() => _assistantcompletedState();
}

class _assistantcompletedState extends State<assistantcompleted> {
